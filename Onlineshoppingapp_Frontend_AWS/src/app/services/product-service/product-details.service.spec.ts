...
let productDetailsResp: ProductDetails = {
  productId: 1,
  productName : "Shampoo", 
  ...
  it('should call addNewProduct', () => {
    spyOn(httpUtil, 'addNewProductToDatabase').and.returnValue(of(productDetailsResp));
    service.addNewProduct(productDetailsResp);
    expect(service.addNewProduct).toBeDefined();
  });

  it('should call getProductsByName', () => {
    spyOn(httpUtil, 'getProductsByNameFromDatabase').and.returnValue(of(productDetailsResp));
    service.getProductsByName('soap');
    expect(service.getProductsByName).toBeDefined();
  });

  it('should call deleteProduct', () => {
    spyOn(httpUtil, 'deleteProductFromDatabase').and.returnValue(of(productDetailsResp));
    service.deleteProduct(productDetailsResp);
    expect(service.deleteProduct).toBeDefined();
  });

  it('should call updateProductDetails', () => {
    spyOn(httpUtil, 'updateProductInDatabase').and.returnValue(of(productDetailsResp));
    service.updateProductDetails(productDetailsResp);
    expect(service.updateProductDetails).toBeDefined();
  });
